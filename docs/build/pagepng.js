...
(async () => {
    ...
    const pdfData = fs.readFileSync(path.resolve(__dirname, '..', ({learning: 'HONCO_CHAT_PROJECT_LEARNING_GUIDE.pdf', manual: 'HONCO_CHAT_BUTTON_MANUAL.pdf'}[process.env.DOC] || 'HONCO_CHAT_COMPLETE_DOCUMENTATION.pdf'))).toString('base64');
